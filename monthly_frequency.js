...
(()=>{if(typeof document==="undefined")return;if(document.querySelector('script[data-dwd-daily-map]'))return;const s=document.createElement("script");s.src="dwd_station_daily_map.js?v=4";s.dataset.dwdDailyMap="1";document.body.appendChild(s)})();
