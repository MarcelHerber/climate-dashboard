...
def main() -> int:
    ...
    if not args.no_current:
        try:
            ...
            core.log(f"WARNUNG: GHCN {current_year} konnte nicht aktualisiert werden; Historical-Stand bleibt online: {exc}")
    ...
    # Source hierarchy: GHCN base first, then national sources replace DE/FR.
